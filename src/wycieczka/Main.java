...
public class Main {
    public static void main(String[] args) {
        ...
        Przewodnik przewodnik1 = new Przewodnik("Adam", "Nowak", "0048987654321", 4900, "polski");
        PracownikObslugiKlienta pracownikObslugi1 = new PracownikObslugiKlienta("Anna", "Jankowska", 5100, "0048456123987");

        Wycieczka w1 = new WycieczkaKrajowa(2410, "Zwiedzanie", 3.5, przewodnik1, "Krakow");
        Wycieczka w2 = new WycieczkaKrajowa(3900, "Zwiedzanie", 2.8, przewodnik1, "Warszawa");
